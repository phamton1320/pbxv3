                                    ...
                                    <div id="example">
                                        ...
                                        <script>
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $("#grid").kendoGrid({
                                                    ...
                                                    columns: [
                                                        ...
                                                        { command: [{name:"edit"},{name:"destroy"},{text: "Agent",iconClass: "k-icon k-i-user", click: showDetails}], title:  "Action", width: "300px" },
                                            ...
                                            function showDetails(e) {
                                                //e.preventDefault(); // Ngan lien ket di theo URL
                                                //var tr = $(this).closest('tr');
                                                var rowItem = this.dataItem($(e.currentTarget).closest("tr"));
                                                // lay du lieu trong kendo vd: lay name. rowItem.name.
                                                var id = rowItem.id;
                                                window.location.href = 'http://localhost/pbxv3/QueuesController/agent/'+id;
                                                ...
                                                // //console.log(wnd.content(detailsTemplate(dataItem)));
                                                // wnd.center().open();
                                            }
                                            //end ShowDetails
